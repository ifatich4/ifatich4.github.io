<template>
    <div class="tabsCustom">
        <div class="card tabMenu">
            ...
            <!-- Varian satu: Menampilkan langsung daftar label -->
            ...
            <!-- Varian dua: Menggunakan slot custom-labels untuk Accordion -->
            <template v-else-if="variant === 'dua'">
                <Accordion>
                    <!-- Iterasi untuk menampilkan beberapa AccordionItem -->
        ...
        <div class="card tabContent">
            <!-- Menampilkan konten langkah berdasarkan slot dinamis -->
