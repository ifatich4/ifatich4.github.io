...
import logoPegadaian from "@/assets/images/logo-pegadaian.svg";
...
// State untuk Showcase 4 Komponen Upload & Preview (FilePickerLG, FilePickerSM, ImageView, InputKtp)
const scLgImage = ref(null)
const scLgPdf = ref(null)
const scLgCsv = ref(null)
const scLgAll = ref(null)
const scLgPrefilled = ref('https://images.unsplash.com/photo-1610375461246-83df859d849d?w=800&auto=format&fit=crop&q=80')
const scLgModalLoader = ref(null)

const scSmImage = ref(null)
const scSmAll = ref(null)
const scSmPdf = ref(null)
const scSmCsv = ref(null)
const scSmPrefilled = ref('https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=800&auto=format&fit=crop&q=80')

const scKtpStandard = ref('')
const scKtpGeneral = ref('')
const scKtpWithTimestamp = ref('https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=800&auto=format&fit=crop&q=80')
const scKtpPreviewFilled = ref('https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=800&auto=format&fit=crop&q=80')
const scKtpPreviewBlank = ref('')
const scKtpPreviewBroken = ref('https://invalid-domain-simulation-12345.com/broken.jpg')

const sampleGold1to1 = 'https://images.unsplash.com/photo-1610375461246-83df859d849d?w=800&auto=format&fit=crop&q=80'
const sampleCertificate2to3 = 'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=800&auto=format&fit=crop&q=80'
const sampleJewelry3to2 = 'https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?w=800&auto=format&fit=crop&q=80'
const sampleKtpPhoto = 'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=800&auto=format&fit=crop&q=80'
...
export default {
  ...
  data() {
    const radioDefaultActiveIcon = new URL("../assets/icon/icon-system/icon-radio-on.svg", import.meta.url).href;
    const radioDefaultInactiveIcon = new URL("../assets/icon/icon-system/icon-radio-off.svg", import.meta.url).href;
    const radioStatusActiveIcon = new URL("../assets/icon/icon-system/icon-status-active.svg", import.meta.url).href;
    const radioStatusInactiveIcon = new URL("../assets/icon/icon-system/icon-status-inactive.svg", import.meta.url).href;
    const radioCheckIcon = new URL("../assets/icon/icon-system/icon-check-round.svg", import.meta.url).href;
    const radioInfoIcon = new URL("../assets/icon/icon-system/icon-info.svg", import.meta.url).href;

    return {
      activeLabel: null,
      radioDefaultActiveIcon,
      radioDefaultInactiveIcon,
      radioStatusActiveIcon,
      radioStatusInactiveIcon,
      radioCheckIcon,
      radioInfoIcon,
      ...
      selectedRadio: "option1", // Nilai yang dipilih dari radio
      selectedRadioVariant: "default",
      selectedRadioSlotVariant: "info",
      radioItems: [
      ...
      radioVariantItems: [
        {
          value: "default",
          text: "Belum Diisi",
          activeIcon: radioStatusActiveIcon,
          inactiveIcon: radioStatusInactiveIcon,
        },
        {
          value: "incomplete",
          text: "Belum Lengkap",
          activeIcon: radioStatusActiveIcon,
          inactiveIcon: radioStatusActiveIcon,
        },
        {
          value: "complete",
          text: "Form Sudah Lengkap",
          activeIcon: radioCheckIcon,
          inactiveIcon: radioCheckIcon,
        },
        {
          value: "info",
          text: "SLA",
      ...
      radioSlotVariantItems: [
        { value: "radio", text: "Default Radio" },
        {
          value: "status",
          text: "Custom Status",
          activeIcon: radioStatusActiveIcon,
      ...
      nilaiTerpilih: null,
      daftarPilihan: [
        { id: 1, img: "beli_emas", nama: "Pilihan 1", link: "asa", disabled: true },
      ...
      tableJaminanDatas: [
      {
        ...
        fotoJaminan: [
          { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "12 Jan 2024", timeImages: "13:00" },
          { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "13 Jan 2024", timeImages: "12:00" },
          { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "14 Jan 2024", timeImages: "11:00" },
          { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "15 Jan 2024", timeImages: "10:00" },
        ],
      },
      {
        id: 2,
        ...
        fotoJaminan: [
          { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "16 Jan 2024", timeImages: "13:00" },
          { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "17 Jan 2024", timeImages: "11:00" },
        ]
      },
      {
        id: 3,
        ...
        fotoJaminan: [
          { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "18 Jan 2024", timeImages: "09:00" },
          { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "19 Jan 2024", timeImages: "10:00" },
        ]
      },
      {
        id: 4,
        ...
        fotoJaminan: [
          { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "15 Jan 2024", timeImages: "13:00" },
          { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "15 Jan 2024", timeImages: "12:00" },
        ]
      },
      {
        id: 5,
        ...
        fotoJaminan: [
          { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "16 Jan 2024", timeImages: "13:00" },
          { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=800", dateImages: "16 Jan 2024", timeImages: "12:00" },
        ]
      }
       ],
       ...
       tableKreditBarangJaminan: [
      {
        ...
        daftarJaminan: [{
          ...
          fotoJaminan: [
            { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "10 Feb 2024", timeImages: "09:30" },
            { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "10 Feb 2024", timeImages: "09:45" },
          ],
        },
        {
          id: 2,
          ...
          rincianBarangJaminan: [
           ...
           fotoJaminan:  [
            { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "15 Mar 2024", timeImages: "14:20" },
            { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "15 Mar 2024", timeImages: "14:25" },
          ],
        },
        {
          id: 3,
          ...
          rincianBarangJaminan: [
           ...
           fotoJaminan:  [
            { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "12 Jan 2024", timeImages: "13:00" },
            { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "12 Jan 2024", timeImages: "12:00" },
          ],
        },
      ],
        fotoJaminan: [
      ...
      },
      {
        ...
        daftarJaminan: [{
          ...
          fotoJaminan:  [
            { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "20 Apr 2024", timeImages: "11:00" },
            { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "20 Apr 2024", timeImages: "11:05" },
          ],
        },
      ],
        fotoJaminan:  [
      ...
      },
      {
        ...
        daftarJaminan: [{
          ...
          rincianBarangJaminan: [
           ...
           fotoJaminan: [
            { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=803", dateImages: "20 Apr 2024", timeImages: "11:00" },
            { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=804", dateImages: "20 Apr 2024", timeImages: "11:05" },
          ],
        },
      ],
      fotoJaminan: [
      ...
      },
      {
        ...
        daftarJaminan:  [{
          ...
          fotoJaminan:   [
            { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=809", dateImages: "20 Apr 2024", timeImages: "11:00" },
            { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "20 Apr 2024", timeImages: "11:05" },
          ],
        },
      ],
      ...
      },
      {
        ...
        fotoBuktiPemeriksaan : [
          { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=80", dateImages: "12 Jan 2024", timeImages: "13:00" },
          { src: "https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400&auto=format&fit=crop&q=800", dateImages: "12 Jan 2024", timeImages: "12:00" },
        ],
      },
      {
        id: 5,
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <InputSmallText
                id="13"
                title="Input Small Text"
                :icon="whatsappIcon"
                :iconLabel="whatsappIcon"
              ...
              <InputText
                ...
                label="Ini Caps Sample | Input Text"
                class="pb-0"
              >
                <template #label-icon>
                  <img
              ...
              <Accordion class="mb-2" v-model="modelAccordion">
                <AccordionItem variant="big" header="Informasi Pengajuan (Variant Big)">
                  <div>Informasi terkait pemohon cuti, tanggal cuti, dan durasinya ada di sini.</div>
                </AccordionItem>
        ...
        <div class="col-lg-6 mt-4">
          <div class="card">
            <div class="card-header">
              <h5>File Picker (Large & Small)</h5>
              <p class="mb-0">
                <code>Contoh penggunaan komponen FilePickerLG dan FilePickerSM</code>
              </p>
              <div class="alert alert-info mt-2 px-3 py-2">
                <small><strong>Note:</strong> Untuk mengecek secara visual loadernya, silakan pilih/upload file apa saja. Loader akan muncul simulasi selama 1 detik. Bisa berupa titik-titik (<code>inline</code>) atau overlay layar (<code>modal</code>), tergantung pada props <code>loaderType</code>.</small>
              </div>
            </div>
            <div class="card-body">
              <FilePickerLG
              ...
              <FilePickerLG
                ...
                :image-only="false"
                :csv-only="true"
                errorText="Format file salah atau terlalu besar."
                @fileDropped="handleFileDropped"
                @fileRemoved="handleFileRemoved"
              />
              ...
              <FilePickerLG
                v-model="selectedFile"
                :image-only="true"
                file="https://raw.githubusercontent.com/vuejs/art/master/logo.png"
                @fileDropped="handleFileDropped"
                @fileRemoved="handleFileRemoved"
              />

              <br/>
              <label class="font-weight-bold mb-2">FilePickerLG (Hanya PDF, Max 2MB, Loader Modal)</label>
              <FilePickerLG
                v-model="selectedFile"
                pdf-only
                :max-size="2 * 1024 * 1024"
                loaderType="modal"
                errorText="File harus PDF dan maksimal 2 MB."
                @fileDropped="handleFileDropped"
                @fileRemoved="handleFileRemoved"
              />
              ...
              <p class="font-weight-bold mb-2">5. FilePickerSM (Hanya Gambar)</p>
              <div style="width: 80px; height: 80px;">
                <FilePickerSM
                  :image-only="true"
                  errorText="Error upload"
                  @input="handleFileDroppedGeneral"
                />
              </div>

              <p class="font-weight-bold mt-4 mb-2">6. FilePickerSM (Semua File)</p>
              <div style="width: 80px; height: 80px;">
                <FilePickerSM
                  :image-only="false"
                  :csv-only="false"
              ...
              <p class="font-weight-bold mt-4 mb-2">7. FilePickerSM (Pre-filled Data)</p>
              <div style="width: 80px; height: 80px;">
                <FilePickerSM
                  :image-only="true"
                  file="https://raw.githubusercontent.com/vuejs/art/master/logo.png"
              ...
              <p class="font-weight-bold mt-4 mb-2">8. FilePickerSM (Hanya PDF, Max 2MB)</p>
              <FilePickerSM
                :image-only="false"
                :pdf-only="true"
                :max-size="2 * 1024 * 1024"
        ...
        <div class="col-12 mt-4">
          <div class="card">
            <div class="card-header">
              <h5>ImageView — Semua Varian Aspect Ratio</h5>
              <p class="mb-0">
                Komponen ImageView mendukung aspect ratio preset: <code>3:2</code>, <code>4:3</code>, <code>16:9</code>, <code>21:9</code>, <code>1:1</code>, <code>9:16</code>, <code>3:4</code>, <code>2:3</code>, <code>ktp</code>, serta custom ratio. Klik gambar untuk membuka modal preview dengan timestamp.
              </p>
            </div>
            <div class="card-body">

              <!-- Landscape Variants -->
              <p class="fw-bold mb-2 mt-2">📐 Landscape Ratios</p>
              <div class="row g-3 mb-4">
                <div class="col-md-4">
                  <ImageView
                    ...
                    aspect-ratio="3:2"
                    fluid
                    img-src="https://images.unsplash.com/photo-1472214103451-9374bd1c798e?w=1200&h=800&auto=format&fit=crop&q=85"
                    img-alt="Pantai 3:2"
                    previewable
                    show-zoom-icon
                    uploader="P12345"
                ...
                <div class="col-md-4">
                  <ImageView
                    ...
                    aspect-ratio="4:3"
                    fluid
                    img-src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=1200&h=900&auto=format&fit=crop&q=85"
                    img-alt="Alam 4:3"
                    previewable
                    show-zoom-icon
                    uploader="Admin"
                ...
                <div class="col-md-4">
                  <ImageView
                    ...
                    aspect-ratio="16:9"
                    fluid
                    img-src="https://images.unsplash.com/photo-1519125323398-675f0ddb6308?w=1920&h=1080&auto=format&fit=crop&q=85"
                    img-alt="Pemandangan 16:9"
                    previewable
                    show-zoom-icon
                  />
                </div>
                <div class="col-md-12">
                  <ImageView
                    title="21:9 — Ultrawide / Cinematic"
                    aspect-ratio="21:9"
                    fluid
                    img-src="https://images.unsplash.com/photo-1501854140801-50d01698950b?w=2100&h=900&auto=format&fit=crop&q=85"
                    img-alt="Cinematic 21:9"
                    previewable
                    show-zoom-icon
                  />
                </div>
              ...
              <!-- Portrait Variants -->
              <p class="fw-bold mb-2">📐 Portrait & Square Ratios</p>
              <div class="row g-3 mb-4">
                <div class="col-6 col-md-3">
                  <ImageView
                    ...
                    aspect-ratio="1:1"
                    fluid
                    img-src="https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=800&h=800&auto=format&fit=crop&q=85"
                    img-alt="Foto 1:1"
                    previewable
                    show-zoom-icon
                ...
                <div class="col-6 col-md-3">
                  <ImageView
                    title="9:16 — Story / Portrait"
                    aspect-ratio="9:16"
                    fluid
                    img-src="https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?w=900&h=1600&auto=format&fit=crop&q=85"
                    img-alt="Story 9:16"
                    previewable
                    show-zoom-icon
                  />
                ...
                <div class="col-6 col-md-3">
                  <ImageView
                    ...
                    aspect-ratio="3:4"
                    fluid
                    img-src="https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=900&h=1200&auto=format&fit=crop&q=85"
                    img-alt="Portrait 3:4"
                    previewable
                    show-zoom-icon
                  />
                </div>
                <div class="col-6 col-md-3">
                  <ImageView
                    title="2:3 — Tall Portrait"
                    aspect-ratio="2:3"
                    fluid
                    img-src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=800&h=1200&auto=format&fit=crop&q=85"
                    img-alt="Portrait 2:3"
                    previewable
                    show-zoom-icon
                  />
                </div>
              ...
              <!-- Special / States -->
              <p class="fw-bold mb-2">🪪 Special Ratio & States</p>
              <div class="row g-3">
                <div class="col-md-4">
                  <ImageView
                    title="KTP — 85.6:54"
                    aspect-ratio="ktp"
                    fluid
                    img-src="https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=856&h=540&auto=format&fit=crop&q=85"
                    img-alt="Kartu Identitas KTP"
                    previewable
                    show-zoom-icon
                  />
                </div>
                ...
                <div class="col-md-4">
                  <ImageView
                    title="Broken State (3:2)"
                    aspect-ratio="3:2"
                    fluid
                    img-broken
                    img-src="https://invalid-broken-url.com/nonexistent.png"
                    img-alt="Broken"
                  />
                </div>
              </div>
        ...
        <!-- ImageView Usage Cases -->
        <div class="col-12 mt-4">
          <div class="card">
            <div class="card-header">
              <h5>ImageView — Kasus Penggunaan</h5>
              <p class="mb-0">
                Tiga kasus umum: tanpa info tambahan, dengan timestamp, dan dengan footer action di dalam modal.
              </p>
            </div>
            <div class="card-body">
              <div class="row g-4">

                <!-- Case 1: Basic — no timestamp, no footer -->
                <div class="col-md-4">
                  <p class="fw-semibold mb-2 small text-uppercase text-muted">📷 Basic — Tanpa Timestamp</p>
                  <ImageView
                    title="Foto Lokasi"
                    aspect-ratio="3:2"
                    fluid
                    img-src="https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=1200&h=800&auto=format&fit=crop&q=85"
                    img-alt="Foto Lokasi"
                    previewable
                    show-zoom-icon
                  />
                  <p class="mt-2 small text-muted">
                    Hanya menampilkan gambar. Klik untuk preview fullscreen tanpa informasi tambahan.
                  </p>
                </div>

                <!-- Case 2: With timestamp -->
                <div class="col-md-4">
                  <p class="fw-semibold mb-2 small text-uppercase text-muted">🕐 Dengan Timestamp</p>
                  <ImageView
                    title="Foto Jaminan Emas"
                    aspect-ratio="3:2"
                    fluid
                    img-src="https://images.unsplash.com/photo-1610375461246-83df859d849d?w=1200&h=800&auto=format&fit=crop&q=85"
                  ...
                  />
                  <p class="mt-2 small text-muted">
                    Timestamp (uploader + waktu) hanya tampil di dalam modal preview, bukan pada thumbnail.
                  </p>
                </div>

                <!-- Case 3: With footer slot -->
                <div class="col-md-4">
                  <p class="fw-semibold mb-2 small text-uppercase text-muted">🔧 Dengan Footer Action</p>
                  <ImageView
                    title="Dokumen KTP"
                    aspect-ratio="ktp"
                    fluid
                    img-src="https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=800&auto=format&fit=crop&q=80"
                    img-alt="Dokumen KTP"
                    previewable
                    show-zoom-icon
                    uploader="CS-002 / Rina"
                    date="10 Juli 2024"
                    time="14:20 WIB"
                  >
                    <template #footer="{ hide }">
                      <Button class="me-2 mb-2" type="neutral" label="Tolak Dokumen" size="md" @click="hide" />
                      <Button class="me-2 mb-2" type="primary" label="Verifikasi" size="md" @click="hide" />
                    </template>
                  </ImageView>
                  <p class="mt-2 small text-muted">
                    Slot <code>#footer</code> menambahkan tombol aksi di bawah modal. Contoh: verifikasi atau tolak dokumen.
                  </p>
                </div>
        ...
        <!-- ImageView Whitespace Modal Preview Cases (3:2, KTP, 2:3) -->
        <div class="col-12 mt-4">
          <div class="card">
            <div class="card-header bg-light">
              <h5 class="mb-1">ImageView — Preview Modal Whitespace (Rasio 3:2, KTP, dan 2:3)</h5>
              <p class="mb-0 text-muted small">
                Ketika modal preview menggunakan rasio <strong>3:2</strong>, <strong>KTP</strong>, atau <strong>2:3</strong> dan sumber gambar memiliki orientasi / aspek rasio berbeda (misal portrait di modal landscape atau sebaliknya), modal akan menampilkan <strong>white space (tidak crop / fit paksa)</strong> agar seluruh gambar terlihat utuh.
              </p>
            </div>
            <div class="card-body">
              <div class="row g-4">

                <!-- Case 1: Modal Rasio 3:2 dengan Foto Portrait (3:4 / 9:16) -->
                <div class="col-md-4">
                  <div class="p-3 border rounded-3 h-100 bg-white">
                    <span class="badge bg-success mb-2">Kasus 1: Rasio 3:2</span>
                    <p class="fw-semibold mb-1">Foto Portrait dalam Modal 3:2</p>
                    <p class="small text-muted mb-3">
                      Sumber gambar bertipe portrait (tinggi). Saat di-klik preview, gambar tidak akan terpotong dan sisi kiri-kanan akan memiliki <strong>white space</strong>.
                    </p>
                    <ImageView
                      title="Foto Dokumen Portrait"
                      aspect-ratio="3:2"
                      fluid
                      img-src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=600&h=900&auto=format&fit=crop&q=85"
                      img-alt="Portrait Photo"
                      previewable
                      show-zoom-icon
                      uploader="Petugas Penaksir 01"
                      date="01 Sep 2026"
                      time="10:15 WIB"
                    />
                  </div>
                ...
                <!-- Case 2: Modal Rasio KTP (85.6:54) dengan Foto Bebas / Square -->
                <div class="col-md-4">
                  <div class="p-3 border rounded-3 h-100 bg-white">
                    <span class="badge bg-primary mb-2">Kasus 2: Rasio KTP</span>
                    <p class="fw-semibold mb-1">Foto Persegi/Square dalam Modal KTP</p>
                    <p class="small text-muted mb-3">
                      Sumber gambar rasio 1:1. Saat di-preview dalam modal rasio KTP, gambar ditampilkan utuh dengan <strong>white space</strong> di samping tanpa terpotong.
                    </p>
                    <ImageView
                      title="Dokumen Kartu Identitas"
                      aspect-ratio="ktp"
                      fluid
                      img-src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=800&h=800&auto=format&fit=crop&q=85"
                      img-alt="KTP Card Ratio"
                      previewable
                      show-zoom-icon
                      uploader="CS Cabang Kramat"
                      date="01 Sep 2026"
                      time="11:30 WIB"
                    />
                  </div>
                ...
                <!-- Case 3: Modal Rasio 2:3 (Portrait) dengan Foto Landscape (16:9 / 3:2) -->
                <div class="col-md-4">
                  <div class="p-3 border rounded-3 h-100 bg-white">
                    <span class="badge bg-warning text-dark mb-2">Kasus 3: Rasio 2:3</span>
                    <p class="fw-semibold mb-1">Foto Landscape dalam Modal 2:3</p>
                    <p class="small text-muted mb-3">
                      Sumber gambar landscape lebar (16:9). Saat di-preview dalam modal 2:3 (portrait), gambar utuh dengan <strong>white space</strong> di atas dan bawah.
                    </p>
                    <ImageView
                      title="Foto Bangunan Jaminan"
                      aspect-ratio="2:3"
                      fluid
                      img-src="https://images.unsplash.com/photo-1513694203232-719a280e022f?w=1200&h=675&auto=format&fit=crop&q=85"
                      img-alt="Landscape Photo in 2:3"
                      previewable
                      show-zoom-icon
                      uploader="Surveyor Lapangan"
                      date="01 Sep 2026"
                      time="14:00 WIB"
                    />
                  </div>
        ...
        <!-- ImageView Mode Preview Prop (Trigger 1:1 120x120px, Modal follows aspect-ratio) -->
        <div class="col-12 mt-4">
          <div class="card">
            <div class="card-header bg-light">
              <h5 class="mb-1">ImageView — Mode Prop <code>preview</code> (Trigger 1:1 120x120px)</h5>
              <p class="mb-0 text-muted small">
                Ketika prop <code>preview</code> diaktifkan, thumbnail trigger otomatis berukuran tetap <strong>120 &times; 120 px (rasio 1:1)</strong>, namun saat diklik modal preview-nya tetap menyesuaikan dengan <code>aspect-ratio</code> yang ditentukan (misal 3:2, KTP, atau 2:3).
              </p>
            </div>
            <div class="card-body">
              <div class="d-flex flex-wrap gap-4 align-items-start">

                <!-- Preview Mode 1: aspect-ratio 3:2 -->
                <div class="p-3 border rounded-3 bg-white text-center">
                  <span class="badge bg-success mb-2">Modal: 3:2</span>
                  <p class="small text-muted mb-2">Trigger 120x120 &rarr; Modal 3:2</p>
                  <ImageView
                    title="Foto Jaminan"
                    preview
                    aspect-ratio="3:2"
                    img-src="https://images.unsplash.com/photo-1610375461246-83df859d849d?w=1200&h=800&auto=format&fit=crop&q=85"
                    img-alt="Foto Jaminan 3:2"
                    show-zoom-icon
                    uploader="Petugas Penaksir"
                    date="01 Sep 2026"
                    time="10:00 WIB"
                  />
                </div>

                <!-- Preview Mode 2: aspect-ratio ktp -->
                <div class="p-3 border rounded-3 bg-white text-center">
                  <span class="badge bg-primary mb-2">Modal: KTP</span>
                  <p class="small text-muted mb-2">Trigger 120x120 &rarr; Modal KTP</p>
                  <ImageView
                    title="Foto KTP"
                    preview
                    aspect-ratio="ktp"
                ...
                <!-- Preview Mode 3: aspect-ratio 2:3 (portrait) -->
                <div class="p-3 border rounded-3 bg-white text-center">
                  <span class="badge bg-warning text-dark mb-2">Modal: 2:3</span>
                  <p class="small text-muted mb-2">Trigger 120x120 &rarr; Modal 2:3</p>
                  <ImageView
                    title="Dokumen Portrait"
                    preview
                    aspect-ratio="2:3"
                    img-src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=600&h=900&auto=format&fit=crop&q=85"
                    img-alt="Foto Portrait 2:3"
                    show-zoom-icon
                    uploader="Surveyor"
                    date="01 Sep 2026"
                    time="13:45 WIB"
                ...
                <!-- Preview Mode 4: aspect-ratio 16:9 -->
                <div class="p-3 border rounded-3 bg-white text-center">
                  <span class="badge bg-secondary mb-2">Modal: 16:9</span>
                  <p class="small text-muted mb-2">Trigger 120x120 &rarr; Modal 16:9</p>
                  <ImageView
                    title="Lokasi Agunan"
                    preview
                    aspect-ratio="16:9"
                    img-src="https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=1200&h=800&auto=format&fit=crop&q=85"
                    img-alt="Lokasi Agunan 16:9"
                    show-zoom-icon
                    uploader="Surveyor 02"
                    date="01 Sep 2026"
                    time="15:30 WIB"
                  />
                </div>
  ...
  <template #tooltip="{ label, value, datasetLabel }">
    <div class="p-2 text-xs">
      ...
      {{ label }} — <span class="text-green-600">{{ value }}</span>
          ...
          <div class="card">
            ...
            <div class="card-body">
              <div class="d-flex flex-column gap-4">
                <div>
                  <h6 class="mb-2">Default Icon</h6>
                  <RadioComponent
                    :items="radioItems"
                    :active-icon="radioDefaultActiveIcon"
                    :inactive-icon="radioDefaultInactiveIcon"
                    v-model="selectedRadio"
                  />
                  <small class="d-block mt-2">Selected: {{ selectedRadio }}</small>
                </div>

                <div>
                  <h6 class="mb-2">Variant Icon Per Item</h6>
                  <RadioComponent
                    :items="radioVariantItems"
                    v-model="selectedRadioVariant"
                  />
                  <small class="d-block mt-2">Selected: {{ selectedRadioVariant }}</small>
                </div>

                <div>
                  <h6 class="mb-2">Custom Icon Slot</h6>
                  <RadioComponent
                    :items="radioSlotVariantItems"
                    v-model="selectedRadioSlotVariant"
                  >
                  ...
                  <small class="d-block mt-2">Selected: {{ selectedRadioSlotVariant }}</small>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="col-lg-6 mt-4">
          <div class="card">
            ...
            <div id="btm-scroll" class="card-body">
              ...
              <!-- InputKTP dengan takenPrefix -->
              <div style="margin-top: 32px; border-top: 2px solid #eee; padding-top: 24px;">
                <h4 style="margin-bottom: 16px;">InputKTP - Timestamp dengan Prefix "Diambil Oleh: [userName]" (:takenPrefix="true")</h4>
                <InputKtp
                  v-model="ktpPhoto"
                  userName="Ahmad Wijaya"
                  :timestamp="true"
        ...
        <!-- ================================================================= -->
        <!-- SECTION TERSENDIRI: 4 KOMPONEN UPLOAD & PREVIEW DALAM SATU CARD  -->
        <!-- 1. FilePickerLG | 2. FilePickerSM | 3. ImageView | 4. InputKTP    -->
        <!-- ================================================================= -->
        <div class="col-lg-12 mt-5 mb-4" id="section-four-components-showcase">
          <div class="card border border-2 shadow-sm rounded-4 overflow-hidden">
            <div class="card-header bg-white p-4 border-bottom">
              <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div>
                  <span class="badge bg-success text-white px-3 py-1 mb-2 font-weight-bold">
                    DOKUMENTASI & SHOWCASE 4 KOMPONEN
                  </span>
                  <h3 class="mb-1 font-weight-bold text-dark">
                    Showcase Komparasi: FilePickerLG, FilePickerSM, ImageView & InputKtp
                  </h3>
                  <p class="text-muted mb-0">
                    Satu card terpadu yang memanggil seluruh varian dari 4 komponen pengelolaan dan preview gambar/dokumen.
                  </p>
                </div>
                <div class="d-flex gap-2 flex-wrap">
                  <a href="#showcase-filepicker-lg" class="btn btn-sm btn-outline-success">1. FilePickerLG</a>
                  <a href="#showcase-filepicker-sm" class="btn btn-sm btn-outline-success">2. FilePickerSM</a>
                  <a href="#showcase-imageview" class="btn btn-sm btn-outline-success">3. ImageView</a>
                  <a href="#showcase-inputktp" class="btn btn-sm btn-outline-success">4. InputKtp</a>
                </div>
              </div>
            </div>
            ...
            <div class="card-body p-4 bg-light">
              ...
              <!-- ======================================================= -->
              <!-- SUB-SECTION 1: FILEPICKER LG                            -->
              <!-- ======================================================= -->
              <div id="showcase-filepicker-lg" class="bg-white p-4 rounded-3 shadow-sm mb-4 border">
                <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                  <div>
                    <h5 class="font-weight-bold mb-1 text-success">
                      1. FilePickerLG (Large File / Image Picker)
                    </h5>
                    <small class="text-muted">
                      Komponen drag-and-drop area besar untuk upload gambar, PDF, CSV, dan dokumen umum.
                    </small>
                  </div>
                  <span class="badge bg-success">Large Drag & Drop</span>
                </div>

                <div class="row g-4">
                  <!-- Varian 1: Hanya Gambar -->
                  <div class="col-md-6 col-lg-4">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <h6 class="font-weight-bold text-dark mb-1">Varian 1: Hanya Gambar</h6>
                      <small class="text-muted d-block mb-3"><code>:image-only="true"</code> • Drag/Drop atau klik, filter image/*</small>
                      <FilePickerLG
                        v-model="scLgImage"
                        :image-only="true"
                        errorText="File terlalu besar, maksimal 1 MB."
                  ...
                  <div class="col-md-6 col-lg-4">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <h6 class="font-weight-bold text-dark mb-1">Varian 2: Hanya Dokumen PDF</h6>
                      <small class="text-muted d-block mb-3"><code>:image-only="false" :pdf-only="true"</code> • Filter file PDF</small>
                      <FilePickerLG
                        v-model="scLgPdf"
                        :image-only="false"
                        :pdf-only="true"
                        errorText="Hanya file PDF yang diperbolehkan."
                        @fileDropped="handleFileDropped"
                        @fileRemoved="handleFileRemoved"
                      />
                    </div>
                  ...
                  <div class="col-md-6 col-lg-4">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <h6 class="font-weight-bold text-dark mb-1">Varian 3: Hanya Dokumen CSV</h6>
                      <small class="text-muted d-block mb-3"><code>:image-only="false" :csv-only="true"</code> • Validasi spreadsheet CSV</small>
                      <FilePickerLG
                        v-model="scLgCsv"
                        :image-only="false"
                        :csv-only="true"
                        errorText="File harus berupa CSV."
                        @fileDropped="handleFileDropped"
                        @fileRemoved="handleFileRemoved"
                      />
                    </div>
                  ...
                  <!-- Varian 4: Semua Format Dokumen -->
                  <div class="col-md-6 col-lg-4">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <h6 class="font-weight-bold text-dark mb-1">Varian 4: Multi Format (Semua File)</h6>
                      <small class="text-muted d-block mb-3"><code>:image-only="false"</code> • PDF, Word, Excel, CSV, Image</small>
                      <FilePickerLG
                        v-model="scLgAll"
                        :image-only="false"
                        :pdf-only="false"
                  ...
                  <!-- Varian 5: Pre-filled Data -->
                  <div class="col-md-6 col-lg-4">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <h6 class="font-weight-bold text-dark mb-1">Varian 5: Pre-filled URL Gambar</h6>
                      <small class="text-muted d-block mb-3"><code>:file="url"</code> • Otomatis menampilkan preview gambar</small>
                      <FilePickerLG
                        :image-only="true"
                        :file="scLgPrefilled"
                        @fileDropped="handleFileDropped"
                  ...
                  <!-- Varian 6: Modal Loader -->
                  <div class="col-md-6 col-lg-4">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <h6 class="font-weight-bold text-dark mb-1">Varian 6: Loader Modal</h6>
                      <small class="text-muted d-block mb-3"><code>loaderType="modal"</code> • Animasi loading fullscreen modal</small>
                      <FilePickerLG
                        v-model="scLgModalLoader"
                        :image-only="true"
                        loaderType="modal"
                        :max-size="2 * 1024 * 1024"
                        @fileDropped="handleFileDropped"
              ...
              <!-- ======================================================= -->
              <!-- SUB-SECTION 2: FILEPICKER SM                            -->
              <!-- ======================================================= -->
              <div id="showcase-filepicker-sm" class="bg-white p-4 rounded-3 shadow-sm mb-4 border">
                <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                  <div>
                    <h5 class="font-weight-bold mb-1 text-success">
                      2. FilePickerSM (Small Compact 80x80px Upload)
                    </h5>
                    <small class="text-muted">
                      Komponen tombol upload 80x80px dengan modal pemilih: Galeri & Kamera (Webcam).
                    </small>
                  </div>
                  <span class="badge bg-success">Compact 80x80px</span>
                </div>

                <div class="row g-4">
                  <!-- SM Varian 1: Image Mode (Galeri & Kamera modal) -->
                  <div class="col-md-6 col-lg-3">
                    <div class="p-3 border rounded-3 h-100 bg-light text-center">
                      <h6 class="font-weight-bold text-dark mb-1">Hanya Gambar</h6>
                      <small class="text-muted d-block mb-3"><code>:image-only="true"</code> • Galeri & Kamera</small>
                  ...
                  <!-- SM Varian 2: Semua File -->
                  <div class="col-md-6 col-lg-3">
                    <div class="p-3 border rounded-3 h-100 bg-light text-center">
                      <h6 class="font-weight-bold text-dark mb-1">Semua Jenis File</h6>
                      <small class="text-muted d-block mb-3"><code>:image-only="false"</code> • Icon Dokumen</small>
                      <div class="d-flex justify-content-center">
                        <FilePickerSM
                          :image-only="false"
                          :csv-only="false"
                          errorText="Gagal upload file"
                          @input="handleFileDroppedGeneral"
                        />
                      </div>
                    </div>
                  ...
                  <!-- SM Varian 3: Pre-filled Image -->
                  <div class="col-md-6 col-lg-3">
                    <div class="p-3 border rounded-3 h-100 bg-light text-center">
                      <h6 class="font-weight-bold text-dark mb-1">Pre-filled Foto</h6>
                      <small class="text-muted d-block mb-3"><code>:file="url"</code> • Thumbnail + Hapus</small>
                      <div class="d-flex justify-content-center">
                        <FilePickerSM
                          :image-only="true"
                          :file="scSmPrefilled"
                  ...
                  <!-- SM Varian 4: PDF Only -->
                  <div class="col-md-6 col-lg-3">
                    <div class="p-3 border rounded-3 h-100 bg-light text-center">
                      <h6 class="font-weight-bold text-dark mb-1">Khusus PDF</h6>
                      <small class="text-muted d-block mb-3"><code>:pdf-only="true"</code> • Max 2MB</small>
                      <div class="d-flex justify-content-center">
                        <FilePickerSM
                          :image-only="false"
                          :pdf-only="true"
                          :max-size="2 * 1024 * 1024"
                          errorText="File harus PDF max 2 MB"
                          @input="handleFileDroppedGeneral"
                        />
                      </div>
                    </div>
              ...
              <!-- ======================================================= -->
              <!-- SUB-SECTION 3: IMAGEVIEW                                -->
              <!-- ======================================================= -->
              <div id="showcase-imageview" class="bg-white p-4 rounded-3 shadow-sm mb-4 border">
                <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                  <div>
                    <h5 class="font-weight-bold mb-1 text-success">
                      3. ImageView (Display & Modal Preview dengan Aspect Ratio & Whitespace)
                    </h5>
                    <small class="text-muted">
                      Komponen display foto jaminan/dokumen dengan rasio utama 1:1 dan 3:2 (landscape), mode preview 120x120px, whitespace letterbox, dan carousel slider.
                    </small>
                  </div>
                  <span class="badge bg-success text-white">Aspect Ratio Engine</span>
                </div>

                <div class="row g-4">
                  <!-- IV 1: Rasio Utama 1:1 -->
                  <div class="col-md-6 col-lg-3">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <span class="badge bg-success mb-2">Rasio Utama 1:1</span>
                      <h6 class="font-weight-bold text-dark mb-1">Emas Batangan (1:1)</h6>
                      <small class="text-muted d-block mb-2">Square crop, previewable</small>
                      <ImageView
                        :imgSrc="sampleGold1to1"
                        aspectRatio="1:1"
                        width="100%"
                  ...
                  <!-- IV 2: Dokumen Portrait 2:3 -->
                  <div class="col-md-6 col-lg-3">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <span class="badge bg-warning text-dark mb-2">Dokumen Portrait 2:3</span>
                      <h6 class="font-weight-bold text-dark mb-1">Sertifikat Agunan (2:3)</h6>
                      <small class="text-muted d-block mb-2">Portrait document, previewable</small>
                      <ImageView
                        :imgSrc="sampleCertificate2to3"
                        aspectRatio="2:3"
                        width="100%"
                        title="Sertifikat Tanah/SHM"
                        previewable
                  ...
                  <!-- IV 3: Mode Prop preview (Trigger 1:1 120x120px -> Modal Ratio 2:3) -->
                  <div class="col-md-6 col-lg-3">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <span class="badge bg-secondary mb-2">Prop preview</span>
                      <h6 class="font-weight-bold text-dark mb-1">Trigger 120x120px (1:1)</h6>
                      <small class="text-muted d-block mb-2">Thumbnail 1:1, modal preview 2:3</small>
                      <ImageView
                        :imgSrc="sampleCertificate2to3"
                        preview
                        modalRatio="2/3"
                        title="Dokumen BPKB"
                        uploader="Verifikator"
                        date="01 Sep 2026"
                        time="11:45"
                      />
                    </div>
                  ...
                  <!-- IV 4: Multi-Image Slider -->
                  <div class="col-md-6 col-lg-3">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <span class="badge bg-primary mb-2">Multi-Image Slider</span>
                      <h6 class="font-weight-bold text-dark mb-1">Slider Jaminan (3 Foto)</h6>
                      <small class="text-muted d-block mb-2">Klik untuk carousel 532px</small>
                      <ImageView
                        :images="sampleSliderImages"
                        aspectRatio="3:2"
                        width="100%"
                        title="Perhiasan Emas & Berlian"
                        previewable
                  ...
                  <!-- IV 5: Whitespace Letterbox 3:2 -->
                  <div class="col-md-6 col-lg-4">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <span class="badge bg-dark mb-2">Whitespace 3:2</span>
                      <h6 class="font-weight-bold text-dark mb-1">Whitespace Preview (3:2)</h6>
                      <small class="text-muted d-block mb-2">Modal batas 532px + whitespace letterbox</small>
                      <ImageView
                        :imgSrc="sampleJewelry3to2"
                        aspectRatio="3:2"
                        width="100%"
                  ...
                  <!-- IV 6: KTP Ratio (85.6/54) -->
                  <div class="col-md-6 col-lg-4">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <span class="badge bg-dark mb-2">Whitespace KTP</span>
                      <h6 class="font-weight-bold text-dark mb-1">e-KTP Nasabah (85.6/54)</h6>
                      <small class="text-muted d-block mb-2">Format kartu identitas standar</small>
                      <ImageView
                        :imgSrc="sampleKtpPhoto"
                        aspectRatio="ktp"
                        width="100%"
                  ...
                  <!-- IV 7: Empty & Broken State -->
                  <div class="col-md-6 col-lg-4">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <span class="badge bg-danger mb-2">Empty & Broken State</span>
                      <h6 class="font-weight-bold text-dark mb-1">Fallback State Ilustrasi</h6>
                      <small class="text-muted d-block mb-2">Tanpa gambar atau saat link rusak</small>
                  ...
                  <!-- IV 8: Rasio Landscape 16:9 (Menyesuaikan rasio di modal) -->
                  <div class="col-md-6 col-lg-4">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <span class="badge bg-info text-white mb-2">Rasio 16:9 (Landscape)</span>
                      <h6 class="font-weight-bold text-dark mb-1">Kantor Cabang (16:9)</h6>
                      <small class="text-muted d-block mb-2">Modal menyesuaikan rasio: 532 &times; 299 px</small>
                      <ImageView
                        imgSrc="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=1200&h=675&auto=format&fit=crop&q=85"
                        aspectRatio="16:9"
                        width="100%"
                        title="Gedung Pegadaian Cabang"
                        previewable
                        uploader="Admin Properti"
                        date="01 Sep 2026"
                        time="08:00"
                      />
                    </div>
                  ...
                  <!-- IV 9: Rasio Portrait 3:4 (Lebar tetap di 532px) -->
                  <div class="col-md-6 col-lg-4">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <span class="badge bg-primary mb-2">Rasio 3:4 (Portrait - Lebar 532)</span>
                      <h6 class="font-weight-bold text-dark mb-1">Foto Nasabah (3:4)</h6>
                      <small class="text-muted d-block mb-2">Lebar tetap 532 px, tinggi menyesuaikan rasio (709 px)</small>
                      <ImageView
                        imgSrc="https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=800&h=1067&auto=format&fit=crop&q=85"
                        aspectRatio="3:4"
                        width="100%"
                        title="Foto Identitas Portrait"
                        previewable
                        uploader="Customer Service"
                        date="01 Sep 2026"
                        time="14:45"
              ...
              <!-- ======================================================= -->
              <!-- SUB-SECTION 4: INPUTKTP                                 -->
              <!-- ======================================================= -->
              <div id="showcase-inputktp" class="bg-white p-4 rounded-3 shadow-sm mb-2 border">
                <div class="d-flex align-items-center justify-content-between border-bottom pb-3 mb-3">
                  <div>
                    <h5 class="font-weight-bold mb-1 text-success">
                      4. InputKtp (Camera Capture, KTP Guidance, Crop & View-Only)
                    </h5>
                    <small class="text-muted">
                      Komponen terpadu pengambilan foto via Kamera/Webcam atau Galeri dengan guidance frame, auto-crop, dan mode preview.
                    </small>
                  </div>
                  <span class="badge bg-success text-white">Camera & KTP Engine</span>
                </div>

                <div class="row g-4">
                  <!-- KTP 1: Mode KTP (Guidance ISO 85.6/54 + Auto-crop) -->
                  <div class="col-md-6 col-lg-4">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <span class="badge bg-success mb-2">Mode KTP (Edit)</span>
                      <h6 class="font-weight-bold text-dark mb-1">Mode KTP (Crop Guidance)</h6>
                      <small class="text-muted d-block mb-3">Frame panduan kartu identitas + Galeri / Kamera</small>
                      <InputKtp
                        v-model="scKtpStandard"
                        mode="ktp"
                        title="Foto e-KTP Nasabah"
                        userName="Ahmad Wijaya"
                        uniqueKey="sc-ktp-mode"
                        :compressionMaxKb="512"
                        @fileDropped="handleKtpModeCapture"
                        @fileRemoved="handleFileRemoved"
                        @errorPermission="handleError"
                  ...
                  <!-- KTP 2: Mode General (Free Upload tanpa Crop Guidance) -->
                  <div class="col-md-6 col-lg-4">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <span class="badge bg-primary mb-2">Mode General (1:1)</span>
                      <h6 class="font-weight-bold text-dark mb-1">Mode General (Bebas 1:1)</h6>
                      <small class="text-muted d-block mb-3">Upload foto wajah / umum rasio 1:1</small>
                      <InputKtp
                        v-model="scKtpGeneral"
                        mode="general"
                        title="Upload Foto Nasabah"
                        userName="Ahmad Wijaya"
                        uniqueKey="sc-general-mode"
                        :compressionMaxKb="1024"
                        @fileDropped="handleGlobalModeCapture"
                        @fileRemoved="handleFileRemoved"
                        @errorPermission="handleError"
                  ...
                  <!-- KTP 3: Timestamp & TakenPrefix -->
                  <div class="col-md-6 col-lg-4">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <span class="badge bg-dark mb-2">Timestamp Overlay</span>
                      <h6 class="font-weight-bold text-dark mb-1">Timestamp & Taken Prefix</h6>
                      <small class="text-muted d-block mb-3"><code>:timestamp="true" :takenPrefix="true"</code></small>
                      <InputKtp
                        v-model="scKtpWithTimestamp"
                        mode="ktp"
                        userName="Ahmad Wijaya"
                        :timestamp="true"
                        :takenPrefix="true"
                        uniqueKey="sc-timestamp-mode"
                        @fileDropped="handleKtpCapture"
                        @errorPermission="handleError"
                      />
                    </div>
                  ...
                  <!-- KTP 4: Mode Preview - Filled (View Only) -->
                  <div class="col-md-6 col-lg-4">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <span class="badge bg-secondary mb-2">Mode Preview (View Only)</span>
                      <h6 class="font-weight-bold text-dark mb-1">State: Filled (Ada Foto)</h6>
                      <small class="text-muted d-block mb-3">Read-only, klik foto untuk preview modal/offcanvas</small>
                      <InputKtp
                        v-model="scKtpPreviewFilled"
                        mode="preview"
                        userName="Ahmad Wijaya"
                        uniqueKey="sc-preview-filled"
                      />
                    </div>
                  </div>

                  <!-- KTP 5: Mode Preview - Blank (Placeholder) -->
                  <div class="col-md-6 col-lg-4">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <span class="badge bg-secondary mb-2">Mode Preview (View Only)</span>
                      <h6 class="font-weight-bold text-dark mb-1">State: Blank (Kosong)</h6>
                      <small class="text-muted d-block mb-3">Menampilkan ilustrasi <code>blank_img.svg</code></small>
                      <InputKtp
                        v-model="scKtpPreviewBlank"
                        mode="preview"
                        userName="Ahmad Wijaya"
                        uniqueKey="sc-preview-blank"
                      />
                    </div>
                  </div>

                  <!-- KTP 6: Mode Preview - Broken (Gambar Rusak) -->
                  <div class="col-md-6 col-lg-4">
                    <div class="p-3 border rounded-3 h-100 bg-light">
                      <span class="badge bg-danger mb-2">Mode Preview (View Only)</span>
                      <h6 class="font-weight-bold text-dark mb-1">State: Broken Image</h6>
                      <small class="text-muted d-block mb-3">Fallback otomatis ke <code>broken_img.svg</code></small>
                      <InputKtp
                        v-model="scKtpPreviewBroken"
                        mode="preview"
                        userName="Ahmad Wijaya"
                        uniqueKey="sc-preview-broken"
                      />
                    </div>
                  </div>
                </div>
