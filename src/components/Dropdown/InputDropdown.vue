...
const handleOptionClick = (option) => {
    if (option[props.itemDisabled]) return
          ...
          <span>
            ...
            <div v-if="!props.useBottomSheet">
                ...
                <BDropdownItem
                    ...
                    :disabled="!!option[props.itemDisabled]"
            ...
            >
                ...
                <ul class="list-group list-group-flush">
                    <li
                        ...
                        :class="{ 'disabled': option[props.itemDisabled] }"
                        :aria-disabled="option[props.itemDisabled] ? true : null"
        ...
        &.show {
            ...
            li {
                ...
                button {
                    ...
                    &.disabled {
                        color: var(--g-kit-black-40) !important;
                        cursor: not-allowed;
